...
function ProgramUpdater({ onBack }) {
  ...
  useEffect(() => {
    ...
    fetch('https://optwebapp-production-c7d6.up.railway.app/channels')
      .then(res => res.json())
      .then(data => {
        setChannels(data.channels || []);
        if (data.channels.includes('DERANA TV')) {
          fetch(`https://optwebapp-production-c7d6.up.railway.app/programs?channel=DERANA TV`)
            .then(res => res.json())
            .then(data => {
  ...
  const handleChannelSelect = (e) => {
    ...
    setSearchTerm('');
    setSlotFilter('');
    fetch(`https://optwebapp-production-c7d6.up.railway.app/programs?channel=${channel}`)
      .then(res => res.json())
      .then(data => {
        const fetched = data.programs || [];
        setPrograms(fetched);
  ...
  const deleteProgram = (program, slot) => {
    ...
    fetch('https://optwebapp-production-c7d6.up.railway.app/delete-program', {
      method: 'POST',
      ...
      .then(() => {
        ...
        fetch('https://optwebapp-production-c7d6.up.railway.app/notify-changes', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
  ...
  const saveChanges = () => {
    ...
    fetch('https://optwebapp-production-c7d6.up.railway.app/update-programs', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const createChannel = () => {
    ...
    fetch('https://optwebapp-production-c7d6.up.railway.app/create-channel', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  const downloadAllProgramsExcel = () => {
    fetch('https://optwebapp-production-c7d6.up.railway.app/export-all-programs')
      .then(res => res.blob())
      .then(blob => {
